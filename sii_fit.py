...
class SII(Lines):
    ...
    def plot_spe(self, ax_in: plt.Axes, i: int, j: int):
        ...
        linewlax = WLAX[1618:1659]
        contwlax = WLAX[1559:1617]
        linespec = self.CUBE[1618:1659,i,j]
        contspec = self.CUBE[1559:1617,i,j]
...
if __name__ == "__main__":
    ...
    hdul.writeto('../Sii_fit/sii_fit_test.fits', overwrite = True)
    ...
    hdul2.writeto('../Sii_fit/sii_rej_test.fits', overwrite = True)
    ...
    hdul3.writeto('../Sii_fit/sii_eval_test.fits', overwrite = True)
    ...
    resulthdus.writeto('../Sii_fit/oi_result_test.fits', overwrite=True)
